    ...
    <x-slot name="MainContent">
        <div class="container-fluid">
            ...
            <ul class="nav nav-pills mb-4 d-flex justify-content-center flex-wrap">
                ...
                <li class="nav-item  me-2 mb-2 ">
                    <a class="nav-link text-white" href="/admin/users/pending"
                        style="background-color: #0d6efd; border-radius: 0.25rem;">Pending Users</a>
                </li>
            </ul>
                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="py-3 px-4 align-middle text-center">
                                            ...
                                            @if (($user->verified ?? 'no') == 'yes')
                                                <span class="badge bg-primary rounded-pill ms-1">Verified</span>
                                            @endif
                                        </td>
