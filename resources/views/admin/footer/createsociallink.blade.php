...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm rounded-lg">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center rounded-top-lg">
            <h5 class="mb-0">New Social Media Details</h5>
            <!-- Optional: Link back to a list of social media links -->
        </div>
        <div class="card-body">
            <form action="/admin/social-media-links/create" method="POST"> {{-- Assuming /admin/social-media-links will handle POST for creation --}}
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control rounded-md shadow-sm" id="platformName" name="name" value="{{ old('platform_name') }}" required>
                </div>

                <!-- URL Field -->
                <div class="mb-3">
                    <label for="platformURL" class="form-label font-weight-bold">URL</label>
                    <input type="text" class="form-control rounded-md shadow-sm" id="platformURL" name="url" value="{{ old('url') }}" required>
                                </div>
